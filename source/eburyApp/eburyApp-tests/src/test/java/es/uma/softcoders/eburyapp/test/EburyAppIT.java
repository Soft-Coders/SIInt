...
public class EburyAppIT {
  ...
  public static void setupClass() {
	  String server="localhost";
		try (InputStream is = EburyAppIT.class.getClassLoader().getResourceAsStream("pom.properties")) {
  ...
  public void setUp() {
    ...
    // TODO Inicializar BaseDatos !!!
    // TODO Pasar Map de propiedades a modificar a EntityManager de BaseDatos !!!
  }
  @After
