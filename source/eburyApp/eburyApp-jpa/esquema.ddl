CREATE TABLE CUENTA (DTYPE VARCHAR(31), SWIFT VARCHAR, NUMERO_CUENTA BIGINT NOT NULL, CODIGO_PAIS VARCHAR(2) NOT NULL, PRIMARY KEY (NUMERO_CUENTA, CODIGO_PAIS))
CREATE TABLE CUENTA_FINTECH (CODIGO_PAIS VARCHAR(2) NOT NULL, NUMERO_CUENTA BIGINT NOT NULL, ESTADO VARCHAR NOT NULL, FECHA_APERTURA DATE NOT NULL, FECHA_CIERRE DATE, CLIENTE_FK BIGINT NOT NULL, PRIMARY KEY (CODIGO_PAIS, NUMERO_CUENTA))
...
CREATE TABLE AUTORIZACION (PERSONA_AUTORIZADA_FK BIGINT, TIPO CHAR, PersonaAutorizada VARCHAR, INDIVIDUAL_FK BIGINT, PERSONAAUT VARCHAR, PERSONA_AUT_FK VARCHAR, Empresa VARCHAR, EMPRESA_FK BIGINT)
...
ALTER TABLE AUTORIZACION ADD CONSTRAINT FK_AUTORIZACION_PERSONA_AUT_FK FOREIGN KEY (PERSONA_AUT_FK) REFERENCES PERSONA_AUTORIZADA (ID)
...
ALTER TABLE AUTORIZACION ADD CONSTRAINT FK_AUTORIZACION_INDIVIDUAL_FK FOREIGN KEY (INDIVIDUAL_FK) REFERENCES CLIENTE (ID)
